...
* **ci:** release workflow + latest.json generator + SLSA L2 provenance (ticket 44) ([f0eeedb](https://github.com/Xxx91n/env-manager/commit/f0eeedbe12fe57a60f7bf0f3938f8377813a2bd6))
...
* **release:** bump version to 0.12.0 + release-please takeover config, retire manual release.yml (ticket 45) ([e098d06](https://github.com/Xxx91n/env-manager/commit/e098d061af4abdf17130fe0225b83e8eb63acb41))
...
* **ci:** quote github.ref_name in release-job latest.json step (ticket 45 tag-run unblock) ([f12d4ce](https://github.com/Xxx91n/env-manager/commit/f12d4ce875d7c49a58c1f10f69b950e4bedd909a))
