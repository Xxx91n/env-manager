...
| `scripts/test-with-restore.ps1` | Live CLI smoke harness: exact full-value HKCU plus accessible HKLM snapshots, raw trailing-backslash command-line regression, exact drift verification, and transactional reconciliation on failure. |
