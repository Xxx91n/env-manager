...
|      +- Core/                # EnvManager.Secrets.Core: ISecretStore (domain facade, ticket 39), ISecretProvider (transport contract), SecretEnvelope + SecretEnvelopeJsonContext, ProviderConfigJsonContext, SecretMount
