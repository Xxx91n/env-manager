...
1. **C# `ScrubExceptionMessage`** (Program.cs): Scrubs 22 secret-bearing patterns from exception
...
3. **C# `SecretString` ref struct** (Program.cs): Wraps decrypted secret values in a zeroing
