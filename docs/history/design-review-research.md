# Design Review Research Notes (2026-08-02)

> **Process artifact — not user documentation.**
> Archived from CONTEXT.md per 3-layer documentation governance (reader × purpose).
> Decisions sedimented into [../adr/](../adr/). Glossary terms retained in [../../CONTEXT.md](../../CONTEXT.md).
> This file is an append-only archive. Do not edit; supersede with new ADRs if needed.
