...
| `profile reveal-secret` | `profile reveal-secret <name> <var>` | v0.7.0. Print one secret's plaintext to stdout. Only the same user account can decrypt (DPAPI CurrentUser). Use sparingly. |
